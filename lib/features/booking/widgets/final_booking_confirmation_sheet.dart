...
import 'package:nest_app/core/theme/app_theme.dart'; // Für Farbdefinitionen
...
class FinalBookingConfirmationSheet extends StatelessWidget {
  ...
  static const Color membershipBannerBackground = Color.fromRGBO(178, 229, 209, 1); // Hellgrün
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontWeight: FontWeight.bold, color: nestDarkText),
                  ),
                ],
              ),
            ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(displayDate, style: const TextStyle(color: nestDarkText, fontSize: 16)),
                    const SizedBox(height: 16),
                    const Text('Time', style: TextStyle(color: nestSecondaryText)),
                    Text(displayTime, style: const TextStyle(color: nestDarkText, fontSize: 16)),
                    const SizedBox(height: 8),
                    const Text(
                      'Included in your membership',
                      style: TextStyle(color: nestGreen, fontSize: 18, fontWeight: FontWeight.bold),
                    ),
                    ...
                    const SizedBox(height: 8),
                    const Text('Your membership covers this booking. No additional payment required.', style: TextStyle(color: nestSecondaryText)),
                    const SizedBox(height: 24),
      ...
      children: [
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Finalizing booking for ${workspaceName}...')),
              );
              // Hier würde die eigentliche Buchung an Supabase gesendet werden
              Navigator.of(context).pop(); // Schließt den FinalBookingConfirmationSheet
            },
            ...
            child: const Text(
              'CONFIRM BOOKING',
              style: TextStyle(color: nestDarkText, fontWeight: FontWeight.bold, fontSize: 14),
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: const Text(
              'CANCEL',
              style: TextStyle(color: nestRed, fontWeight: FontWeight.bold, fontSize: 14),
              textAlign: TextAlign.center,
            ),
          ),
        ),
