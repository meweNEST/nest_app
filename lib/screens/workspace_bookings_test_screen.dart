...
class WorkspaceBookingsTestScreen extends StatefulWidget {
  ...
  @override
  State<WorkspaceBookingsTestScreen> createState() =>
      _WorkspaceBookingsTestScreenState();
}

class _WorkspaceBookingsTestScreenState
    extends State<WorkspaceBookingsTestScreen> {
  ...
  Future<void> _loadBookings() async {
    ...
    try {
      final response = await _supabase.from('workspace_bookings').select('''
            *,
            users!inner(
              full_name,
              email
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              backgroundColor:
                                  _getWorkspaceColor(booking['workspace_type']),
                              child: Icon(
