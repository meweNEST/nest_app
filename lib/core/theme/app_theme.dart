...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge:
          TextStyle(fontSize: 57, fontWeight: FontWeight.bold, color: darkText),
      displayMedium:
          TextStyle(fontSize: 45, fontWeight: FontWeight.bold, color: darkText),
      displaySmall:
          TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: darkText),
      headlineLarge:
          TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: darkText),
      headlineMedium:
          TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: darkText),
      headlineSmall:
          TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: darkText),
      titleLarge:
          TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: darkText),
      titleMedium:
          TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: darkText),
      titleSmall:
          TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: darkText),
